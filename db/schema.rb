...
ActiveRecord::Schema[7.1].define(version: 2024_08_26_100948) do
  ...
  create_table "ad_groups_users", primary_key: ["ad_group_id", "user_id"], charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.integer "ad_group_id", null: false, unsigned: true
    t.integer "user_id", null: false, unsigned: true
    t.index ["user_id"], name: "fk_users_ad_groups_users"
  end

  create_table "adm_users", id: { type: :integer, unsigned: true }, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
